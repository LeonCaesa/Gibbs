...
if __name__ == '__main__':
    ...
    fit_standard = sm.sampling(data = ppca_dat, iter = iterations, chains=n_chains, init = init_list)

    fit_exact = sm.sampling(data = ppca_dat, iter = iterations, chains=n_chains, init = init_list)
